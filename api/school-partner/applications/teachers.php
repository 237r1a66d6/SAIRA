<?php
// Get Teacher Applications for School Partner
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $sql = "SELECT id, full_name, email, phone, qualification, experience_years, 
            subjects, current_school, city, state, status, created_at 
    ...
    sendJsonResponse(true, $applications, 'Teacher applications retrieved', 200);
} else {
